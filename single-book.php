        ...
        <article class="row format-standard">
            ...
            <div class="col-full s-content__main">
                ...
                <?php the_content();
                    ...
                    $philosophy_chaptars = new WP_Query($philosophy_chap_arg);
                    //echo $philosophy_chaptars->found_posts;
                    echo "<h3>";
                    _e('Chaptars', 'philosophy');
                    echo "</h3>";
                    while($philosophy_chaptars->have_posts()){
                        $philosophy_chaptars->the_post();
                        $philosophy_chap_link = get_the_permalink();
                        $philosophy_chap_title = get_the_title();

                        printf('<a href = "%s">%s</a><br/>', $philosophy_chap_link, $philosophy_chap_title);
                    }
                ...
                <div class="s-content__author">
                    ...
                    <div class="s-content__author-about">
                        ...
                        <?php $philosophy_author_instagram = get_field('instagram', 'user_'.get_the_author_meta('ID'));?>
